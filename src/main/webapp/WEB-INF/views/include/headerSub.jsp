								...
								if (flag == 1) {// 스터디 신청
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm "+aClass+"' href='/user/studyManage?target=2'>"
													...
													+ "<div class='col-md-10'><span> '" + sender + "'님이 " + studyName+ "' </span>에 신청하였습니다."
									...
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm "+aClass+"' href='/user/studyManage?target=2'>"
													+ "<div class='col-md-2'><img class='alarm-PR' src='/displayFile?fileName="+ senderPRImgPath + "'></img></div>"
													+ "<div class='col-md-10'><span> '" + sender + "'님이" + studyName+ "' </span>에 신청을 취소하였습니다."
													+ "<small>" + regDate + "</small></div>"
												+"</a>"
											+"</li>");
									...
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm "+aClass+"' href='/user/studyManage'>"
													+ "<div class='col-md-2'><img class='alarm-PR' src='/displayFile?fileName="+ senderPRImgPath + "'></img></div>"
													+ "<div class='col-md-10'><span> '" + sender + "'님이" + studyName+ "' </span>을 북마크에 등록하였습니다."
													+ "<small>" + regDate + "</small></div>"
												+"</a>"
											+"</li>");      
									...
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm "+aClass+"' href='/study/studyView?&studyNo=" + studyNo +"'>"
													+ "<div class='col-md-2'><img class='alarm-PR' src='/displayFile?fileName="+ senderPRImgPath + "'></img></div>"
													+ "<div class='col-md-10'><span> '" + sender + "'님이" + studyName+ "' </span>스터디에 댓글을 남겼습니다."
													+ "<small>" + regDate + "</small></div>"
												+"</a>"
											+"</li>");   
									...
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm "+aClass+"' href='/user/studyManage?target=3'>"
													+ "<div class='col-md-2'><img class='alarm-PR' src='/displayFile?fileName="+ senderPRImgPath + "'></img></div>"
													+ "<div class='col-md-10'><span> '" + sender + "'님이" + studyName+ "' </span>에 참여신청이 승인되었습니다."
													+ "<small>" + regDate + "</small></div>"
												+"</a>"
											+"</li>");
									...
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm note-alarm "+aClass+"' href='/note/noteList'>"
													+ "<div class='col-md-2'><img class='alarm-PR' src='/displayFile?fileName="+ senderPRImgPath + "'></img></div>"
													+ "<div class='col-md-10'><span> '" + sender + "'님이" + studyName+ "' </span>에 참여신청을 거절하였습니다.(쪽지확인)"
													+ "<small>" + regDate + "</small></div>"
												+"</a>"
											+"</li>");
									...
									$('#alarm-list').append(
											"<li>"
												+ "<a data-alarmNo='"+alarmNo+"' class='check-alarm "+aClass+"' href='/study/studyEndView?studyNo="+studyNo+"'>"
													+ "<div class='col-md-2'><img class='alarm-PR' src='/displayFile?fileName="+ senderPRImgPath + "'></img></div>"
													+ "<div class='col-md-10'><span> '" + sender + "'님이" + studyName+ "' </span>를 종료하였습니다"
													+ "<small>" + regDate + "</small></div>"
												+"</a>"
											+"</li>");
								} else {
